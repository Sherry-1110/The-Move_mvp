        ...
        <div className="flex border-b bg-white">
          <button
            ...
            className={`flex-1 py-3 text-center font-medium ${
              currentTab === 'explore' ? 'text-[#4E2A84] border-b-2 border-[#4E2A84]' : 'text-gray-500'
            }`}
          >
            Explore
          </button>
          <button
            ...
            className={`flex-1 py-3 text-center font-medium ${
              currentTab === 'saved' ? 'text-[#4E2A84] border-b-2 border-[#4E2A84]' : 'text-gray-500'
            }`}
          >
            Saved
          </button>
          <button
            ...
            className={`flex-1 py-3 text-center font-medium ${
              currentTab === 'my-moves' ? 'text-[#4E2A84] border-b-2 border-[#4E2A84]' : 'text-gray-500'
            }`}
          >
            My Moves
          </button>
